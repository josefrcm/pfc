...
genKey = do
	...
	t <- listOf $ oneof [choose ('a', 'z'), choose ('A', 'Z'), choose ('0', '9')]
	return (h:t)
...
instance CoArbitrary Valor where
...
instance CoArbitrary Vector where
	coarbitrary = undefined
...
instance CoArbitrary Graficos where
	coarbitrary = undefined
...
instance CoArbitrary Router where
	coarbitrary = undefined
...
instance CoArbitrary Nodo where
	coarbitrary = undefined
...
instance CoArbitrary Arco where
	coarbitrary = undefined
...
instance CoArbitrary Grafo where
	coarbitrary = undefined
